        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm font-semibold text-blue-900">
              Roomly is een nieuw platform voor studenten in Amsterdam
            </p>
            <p className="mt-0.5 text-sm leading-relaxed text-blue-800/80">
              Help ons groeien door een kamer te plaatsen of te reageren op een
              advertentie. Samen bouwen we het beste studentenplatform van
              Nederland.
            </p>
          </div>
        </div>
