    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="mt-16 border-t border-stone-200 pt-12">
        <div className="mx-auto max-w-4xl">
          ...
          {/* Verificatiebanner — compact */}
          <div className="mt-8 flex items-start gap-3 border-l-4 border-emerald-400 pl-4">
            ...
            <p className="text-sm leading-relaxed text-stone-600">
              <span className="font-semibold text-stone-900">Praat met echte mensen via geverifieerde accounts.</span>{" "}
              Verifieer je profiel voor meer vertrouwen tussen huurders en verhuurders.
            </p>
          </div>
        </div>
      </section>
