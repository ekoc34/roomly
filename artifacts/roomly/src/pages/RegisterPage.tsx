      ...
      <div className="rounded-3xl border border-stone-200/80 bg-white p-8 shadow-md">
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4" data-testid="register-form">
          ...
          <div>
            ...
            <input id="reg-password" name="password" type="password" required minLength={8} data-testid="register-password" className="mt-1.5 w-full rounded-xl border border-stone-200 bg-white px-4 py-2.5 text-sm text-stone-900 placeholder:text-stone-400 focus:border-rose-300 focus:outline-none focus:ring-2 focus:ring-rose-200" placeholder="Min. 8 tekens" />
          </div>
          <div>
            <label htmlFor="reg-confirm" className="text-xs font-medium text-stone-700">Herhaal wachtwoord</label>
            <input id="reg-confirm" name="confirm" type="password" required minLength={8} data-testid="register-confirm" className="mt-1.5 w-full rounded-xl border border-stone-200 bg-white px-4 py-2.5 text-sm text-stone-900 placeholder:text-stone-400 focus:border-rose-300 focus:outline-none focus:ring-2 focus:ring-rose-200" placeholder="Herhaal wachtwoord" />
          </div>
