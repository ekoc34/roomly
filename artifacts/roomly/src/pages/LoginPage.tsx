      ...
      <div className="mx-auto max-w-md px-4 py-16 sm:px-6">
        <div className="rounded-3xl border border-stone-200/80 bg-white p-8 shadow-md">
          <div className="text-center">
            ...
            <h1 className="mt-2 text-xl font-bold text-stone-900">{t("auth.loginTitle")}</h1>
            <p className="mt-1 text-sm text-stone-500">{t("auth.loginSubtitle")}</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4" data-testid="login-form">
            <div>
              <label htmlFor="email" className="text-xs font-medium text-stone-700">{t("auth.emailLabel")}</label>
            ...
            <div>
              <label htmlFor="password" className="text-xs font-medium text-stone-700">{t("auth.passwordLabel")}</label>
              ...
              <div className="mt-1.5 flex justify-end">
                <Link href="/wachtwoord-vergeten" className="text-xs text-stone-400 hover:text-stone-600 transition-colors min-h-[1.75rem] inline-flex items-center">{t("auth.forgotPassword")}</Link>
              </div>
            </div>
          ...
          <p className="mt-3 text-center text-sm text-stone-500">
            {t("auth.noAccount")}{" "}
            <Link href={nextParam !== "/dashboard" ? `/registreren?next=${encodeURIComponent(nextParam)}` : "/registreren"} data-testid="login-register-link" className="font-medium text-rose-600 hover:underline">{t("auth.registerLink")}</Link>
          </p>
        </div>
      </div>
    </>
