...
export function HeroSearch() {
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-50 via-white to-amber-50/60 px-6 py-14 shadow-sm ring-1 ring-stone-200/60 sm:px-10 sm:py-20"
    >
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        {/* Active quick filters (previously disabled "Coming soon") */}
