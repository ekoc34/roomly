...
export async function FeaturedListings({ listings }: Props) {
      ...
      <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-500">
            De nieuwste woningen op Roomly.
          </p>
        </div>
        <Link
          href="/kamers"
      ...
      {listings.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-stone-200 bg-white px-6 py-16 text-center shadow-sm">
          ...
          <h3 className="mt-4 text-base font-semibold text-stone-800">
            Nog geen woningen beschikbaar
          </h3>
          <p className="mt-2 max-w-sm text-sm leading-relaxed text-stone-500">
            Er zijn momenteel nog geen advertenties. Plaats als eerste een
            advertentie en help het platform groeien.
          </p>
          <Link
            href="/kamers/nieuw"
