...
export function MobileBottomNav({ unreadMessages = 0 }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-around px-2 py-2">
        ...
        >
          <svg className="h-5 w-5" fill={isFavs ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={isFavs ? 2 : 2}>
        ...
        >
          ...
          {unreadMessages > 0 && (
            <span className="absolute right-3 top-1 flex h-4 min-w-[1rem] items-center justify-center rounded-full bg-rose-500 px-1 text-[9px] font-bold text-white">
