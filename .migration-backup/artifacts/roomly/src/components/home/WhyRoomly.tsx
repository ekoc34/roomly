const ITEMS = [
  ...
  },
  {
    ...
    description: "Chat direct met de verhuurder in het platform. Geen WhatsApp-links, geen e-mailadres delen, geen gedoe.",
  },
  {
    icon: (
    ...
    <section className="mt-16">
      <div className="rounded-3xl border border-stone-200/80 bg-white px-6 py-12 shadow-sm sm:px-10">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {ITEMS.map((item) => (
            <div key={item.title} className="flex flex-col items-start gap-3 rounded-2xl border border-stone-100 bg-stone-50/60 p-5">
